...
const AgentCards = () => {
  const features = [
    ...
    },
    {
      ...
      title: "EHRIQ - Electronic Health Record Management", 
      description: "Comprehensive EHR system integration with automated patient data management, clinical workflow optimization, and seamless record synchronization."
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            Nine AI Agents, Infinite Possibilities
          </h2>
