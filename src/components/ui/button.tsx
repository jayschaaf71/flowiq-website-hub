  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        "brand-cyan": "bg-brand-teal text-white hover:bg-brand-teal-hover shadow-brand hover:shadow-glow font-semibold transition-smooth",
        "brand-orange": "bg-accent text-white hover:bg-accent/90 shadow-brand hover:shadow-glow font-semibold transition-smooth",
        ...
        "cta-accent": "bg-accent text-white hover:bg-accent/90 shadow-brand hover:shadow-glow font-semibold transition-smooth",
